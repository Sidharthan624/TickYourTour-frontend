...
import { fetchPackages } from "../../api/user";
        ...
        const fetchData = async () => {
            try {
                ...
                if(res?.data.success) {
                    ...
                    setTotalPages(Math.floor(res.data.totalPackages / itemsPerPage))
                }
            } catch (error) {
                console.error(error);
                  ...
                  <div className={`${(val.status === 'Verification Required' || val.status === "Rejected" || val.isBlocked === true) && 'hidden'}`}>
                    <article className="relative">
                      <div className="aspect-square overflow-hidden">
                        ...
                        />
                        {val?.providerId?.isVerified && ( // Conditionally render the badge if the property is trusted
