...
import { faTruckPlane, faInbox, faSignOut, faUsers, faUserGroup, faSuitcase, faChartPie, faTags } from '@fortawesome/free-solid-svg-icons'
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-blue-900 dark:bg-gray-800">
          <button
            ...
            className="absolute top-2 right-2 p-1 text-gray-500 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-200 dark:focus:bg-gray-700 sm:hidden"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Providers</span>
              </a>
            </li>
            <li>
              <a
                ...
                className="flex items-center p-2 rounded-lg text-white hover:bg-blue-800 group"
              >
                <FontAwesomeIcon icon={faTruckPlane} className="h-5 w-5" />
